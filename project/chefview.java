...
private JFrame chef;
	...
	private void initialize() throws SQLException 
	{
		...
		chef.getContentPane().setBackground(new Color(207, 144, 58));
		...
		sidebar_cf.setBounds(0, 0,200,1000);
		sidebar_cf.setBackground(new Color(46, 57, 70));
		...
		JLabel restaurantname_cf = new JLabel("NSS Restaurant Group- CHEF");//RESTAURANT NAME
		restaurantname_cf.setFont(new Font("Times New Roman", Font.BOLD, 20));
		...
		ViewOfficialDet_cf.setBounds(10, 271,175, 36);
		...
		UpdateDet_cf.setBounds(10, 318,175, 36);
		...
		ViewBranchDet_cf.setBounds(10, 224,175, 36);
		...
		ViewMenu_cf.setBounds(10, 365,175, 36);
	...
	public Object[][] populate_menu() throws SQLException {
		...
		dishInfo = mobj.ViewMenu("E123");
		return dishInfo;
	}
	
	
	
	public void AddHDetails(String ssn, String Designation) throws Exception {
		HData = hobj.ViewBranchDetails(ssn, Designation);
		...
		hid_viwbrch.setText("Hotel ID: "+"H01");
		hname_viwbrch.setText("Name: " + "NSS Mandarin Oriental");
		strtdt_viwbrch.setText("Start Date: " + "2016/12/7");
		location_viwbrch.setText("Location: " + "Kochi"+ ","+ "Kerala");
	}
