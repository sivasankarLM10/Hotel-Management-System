...
public class headchef {
	...
	private void initialize() throws SQLException 
	{
		...
		h_chef.getContentPane().setBackground(new Color(183, 197, 210));
		...
		sidebar_hcf.setBounds(0, 0,200,1000);
		sidebar_hcf.setBackground(new Color(226, 156, 22));
		...
		title_hcf.setBackground(new Color(74, 87, 93));
		h_chef.getContentPane().add(title_hcf);
		title_hcf.setLayout(null);
		
		JLabel restaurantname = new JLabel("NSS Restaurant Group- HEAD CHEF");//RESTAURANT NAME
		...
		ViewOfficialDet_hcf.setBounds(10, 271,175, 36);
		...
		UpdateDet_hcf.setBounds(10, 318,175, 36);
		...
		ViewMenu_hcf.setBounds(10, 365,175, 36);
		...
		UpdateDishes_hcf.setBounds(10, 412,175, 36);
		sidebar_hcf.add(UpdateDishes_hcf);
		
		Panel panel_hcf = new Panel();
		panel_hcf.setBackground(new Color(0, 173, 217));
		...
		add_dish_hcf_lbl.setBounds(35, 5, 78, 21);
		...
		JButton Addbtn_cf = new JButton("Add Dishes");//add dish button
