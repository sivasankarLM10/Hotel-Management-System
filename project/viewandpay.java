...
public class viewandpay{
	...
	private void initialize() throws SQLException
	{
		...
		sidebar_cust.setBounds(0, 0,200,1000);
		sidebar_cust.setBackground(new Color(170, 39, 35));
		...
		JLabel restaurantname = new JLabel("NSS Restaurant Group- Bill Payment");//RESTAURANT NAME
		...
		JButton BACK = new JButton("Log Out");//BACK BUTTON
		...
		panel_cust.setBackground(new Color(226, 104, 18));
		...
		//Customer Ratings 
		String[] optionsToChoose = {"Not at all","May not", "Neutral", "Likely", "Extremely Likely"};

        String Rating = (String) JOptionPane.showInputDialog(
                null,
                "How would you recommend our Hotel?",
                "Choose an Option",
        ...
        System.out.println("Your chosen Rating: " + Rating);
        JOptionPane.showMessageDialog(alert,"Thanks for your response");
