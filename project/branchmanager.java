...
public class branchmanager extends JFrame{
	...
	private void initialize() throws SQLException 
	{
		...
		branchmanager.getContentPane().setBackground(new Color(30, 64, 124));
		...
		sidebar.setBackground(new Color(255, 197, 45));
		...
		title.setBackground(new Color(226, 104, 18));
		branchmanager.getContentPane().add(title);
		title.setLayout(null);
		
		JLabel restaurantname = new JLabel("NSS Restaurant Group- BRANCH MANAGER");//RESTAURANT NAME
