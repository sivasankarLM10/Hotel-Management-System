...
public class AdminView extends JFrame{
    ...
    public void init() throws Exception{
        try {
          ...
          connect = DriverManager.getConnection("jdbc:postgresql://localhost:5432/hotel","postgres", "password");
	...
	private void initialize() throws Exception {
		...
		frame.getContentPane().setBackground(new Color(237, 104, 100));
		...
		ImageIcon  i = new ImageIcon("E:\\Eclipse workspace\\NSS.png");
		frame.getContentPane().setLayout(null);
		JPanel panel = new JPanel();
		panel.setBounds(0,0,200,1000);
		panel.setBackground(new Color(82, 68, 60));
		...
		JButton btnFireEmployee = new JButton("Employee Termination");
		btnFireEmployee.setFont(new Font("Times New Roman", Font.PLAIN, 10));
		...
		btnFireEmployee.setBounds(10,320, 140, 36);
		panel.add(btnFireEmployee);
		
		
		JButton btnHireEmployee = new JButton("Employee Admission");
		btnHireEmployee.setFont(new Font("Times New Roman", Font.PLAIN, 10));
		...
		btnHireEmployee.setBounds(10,270, 140, 36);
		panel.add(btnHireEmployee);
		
		JButton btnCheckMaintenance = new JButton("Check Maintenance");
		btnCheckMaintenance.setFont(new Font("Times New Roman", Font.PLAIN, 10));
		...
		btnUpdateBranchDetails.setFont(new Font("Times New Roman", Font.PLAIN, 10));
		...
		btnUpdateOfficialDetails.setFont(new Font("Times New Roman", Font.PLAIN, 10));
		...
		btnUpdatePersonalDetails.setFont(new Font("Times New Roman", Font.PLAIN, 9));
		...
		btnUpdatePrices.setFont(new Font("Times New Roman", Font.PLAIN, 10));
		...
		btnProfitability.setFont(new Font("Times New Roman", Font.PLAIN, 10));
		...
		viewBranchBtn.setFont(new Font("Times New Roman", Font.PLAIN, 10));		
		...
		panel_1.setBackground(new Color(224, 146, 45));
		frame.getContentPane().add(panel_1);
		panel_1.setLayout(null);
		
		JLabel lblNewLabel = new JLabel("NSS Restaurant Group- ADMIN");
		...
		panel_2.setBackground(new Color(0,23,66));
		...
		JButton firebtn = new JButton("TERMINATE");//appoint button
		...
		JLabel hire_lbl = new JLabel("Employee Admission");
		...
		JLabel rest_lbl = new JLabel("Select a restaurant");
		rest_lbl.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		rest_lbl.setBounds(6, 56, 138, 20);
		maintenance.add(rest_lbl);
		
		JRadioButton Oriental2 = new JRadioButton("NSS Mandarin Oriental");
		Oriental2.setBounds(113, 83, 179, 23);
		maintenance.add(Oriental2);
		
		JRadioButton Indigo2 = new JRadioButton("NSS Indigo");
		Indigo2.setBounds(113, 111, 179, 23);
		maintenance.add(Indigo2);
		
		JRadioButton Apollo2 = new JRadioButton("NSS New Apollo");
		Apollo2.setBounds(113, 137, 179, 23);
		maintenance.add(Apollo2);
		
		JRadioButton Meadow2 = new JRadioButton("NSS Meadow Manor");
		Meadow2.setBounds(113, 163, 179, 23);
		maintenance.add(Meadow2);
		
		JRadioButton Oasis2 = new JRadioButton("NSS The Oasis");
		Oasis2.setBounds(113, 189, 179, 23);
		maintenance.add(Oasis2);
		...
		chk_btn2.addActionListener(new ActionListener() {
	    	...
	    	{
	    		String str;
	    		 if(Oriental2.isSelected()) {
				    	Hname = "NSS Mandarin Oriental";
				    }
				    
				    if(Indigo2.isSelected()) {
				    	Hname = "NSS Indigo";
				    }
				    
				    if(Apollo2.isSelected()) {
				    	Hname = "NSS New Apollo";
				    }
				    
				    if(Meadow2.isSelected()) {
				    	Hname = "NSS Meadow Manor";
				    }
				    
				    if(Oasis2.isSelected()) {
				    	Hname = "NSS The Oasis";
				    }
		...
		JLabel rest_lbl2 = new JLabel("Select a restaurant");
		rest_lbl2.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		rest_lbl2.setBounds(6, 56, 138, 20);
		updt_branchdet.add(rest_lbl2);
		
		JRadioButton Oriental3 = new JRadioButton("NSS Mandarin Oriental");
		Oriental3.setBounds(113, 83, 179, 23);
		updt_branchdet.add(Oriental3);
		
		JRadioButton Indigo3 = new JRadioButton("NSS Indigo");
		Indigo3.setBounds(113, 111, 179, 23);
		updt_branchdet.add(Indigo3);
		
		JRadioButton Apollo3 = new JRadioButton("NSS New Apollo");
		Apollo3.setBounds(113, 137, 179, 23);
		updt_branchdet.add(Apollo3);
		
		JRadioButton Meadow3 = new JRadioButton("NSS Meadow Manor");
		Meadow3.setBounds(113, 163, 179, 23);
		updt_branchdet.add(Meadow3);
		
		JRadioButton Oasis3 = new JRadioButton("NSS The Oasis");
		Oasis3.setBounds(113, 189, 179, 23);
		updt_branchdet.add(Oasis3);
		...
		submitbtn.addActionListener(new ActionListener() {
	    	...
	    	{
	    		double rev = 0,exp = 0;
	    		 if(Oriental3.isSelected()) {
				    	Hname = "NSS Mandarin Oriental";
				    }
				    
				    if(Indigo3.isSelected()) {
				    	Hname = "NSS Indigo";
				    }
				    
				    if(Apollo3.isSelected()) {
				    	Hname = "NSS New Apollo";
				    }
				    
				    if(Meadow3.isSelected()) {
				    	Hname = "NSS Meadow Manor";
				    }
				    
				    if(Oasis3.isSelected()) {
				    	Hname = "NSS The Oasis";
				    }
		...
		persndt_lbl.setFont(new Font("Times New Roman", Font.BOLD,19));
	...
	//----------------------------------------------View Branch details pane--------------------------------------------------------------
			...
			JLabel rest_lbl3 = new JLabel("Select a restaurant");
			rest_lbl3.setFont(new Font("Times New Roman", Font.PLAIN, 16));
			rest_lbl3.setBounds(6, 56, 138, 20);
			branchdet.add(rest_lbl3);
			
			JRadioButton Oriental4 = new JRadioButton("NSS Mandarin Oriental");
			Oriental4.setBounds(113, 83, 179, 23);
			branchdet.add(Oriental4);
			
			JRadioButton Indigo4 = new JRadioButton("NSS Indigo");
			Indigo4.setBounds(113, 111, 179, 23);
			branchdet.add(Indigo4);
			
			JRadioButton Apollo4 = new JRadioButton("NSS New Apollo");
			Apollo4.setBounds(113, 137, 179, 23);
			branchdet.add(Apollo4);
			
			JRadioButton Meadow4 = new JRadioButton("NSS Meadow Manor");
			Meadow4.setBounds(113, 163, 179, 23);
			branchdet.add(Meadow4);
			
			JRadioButton Oasis4 = new JRadioButton("NSS The Oasis");
			Oasis4.setBounds(113, 189, 179, 23);
			branchdet.add(Oasis4);
			...
			chk_btn3.addActionListener(new ActionListener() {	
		    	...
		    	public void actionPerformed(ActionEvent e) 	
		    	{	
		    		if (Oriental4.isSelected()) {
		    		    Hname = "NSS Mandarin Oriental";
		    		}

		    		if (Indigo4.isSelected()) {
		    		    Hname = "NSS Indigo";
		    		}

		    		if (Apollo4.isSelected()) {
		    		    Hname = "NSS New Apollo";
		    		}

		    		if (Meadow4.isSelected()) {
		    		    Hname = "NSS Meadow Manor";
		    		}

		    		if (Oasis4.isSelected()) {
		    		    Hname = "NSS The Oasis";
		    		}
		    		try {
