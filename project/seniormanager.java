...
public class seniormanager 
{
	...
	private void initialize() throws SQLException 
	{
		...
		sidebar.setBackground(new Color(100, 169, 169));
		...
		JLabel restaurantname = new JLabel("NSS Restaurant Group- Administrative Assistant");//RESTAURANT NAME
		...
		UpdatePrices_sm.setBounds(10, 318,175, 36);
		...
		profitabilitysm.setBounds(10, 365,175, 36);
		sidebar.add(profitabilitysm);
		
		JButton CheckMaint_sm = new JButton("Check maintenance");//Check maintenance Button
		...
		CheckMaint_sm.setBounds(10, 412, 175, 36);
		...
		UpdateDet_sm.setBounds(10, 459, 175, 36);
		...
		JLabel restname_sm = new JLabel("Select a restaurant");
		restname_sm.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		restname_sm.setBounds(6, 56, 138, 20);
		profitsm.add(restname_sm);
		
		JRadioButton Oriental_as = new JRadioButton("NSS Mandarin Oriental");
		Oriental_as.setBounds(113, 83, 179, 23);
		profitsm.add(Oriental_as);
		
		JRadioButton Indigo_as = new JRadioButton("NSS Indigo");
		Indigo_as.setBounds(113, 111, 179, 23);
		profitsm.add(Indigo_as);
		
		JRadioButton Apollo_as = new JRadioButton("NSS New Apollo");
		Apollo_as.setBounds(113, 137, 179, 23);
		profitsm.add(Apollo_as);
		
		JRadioButton Meadow_as = new JRadioButton("NSS Meadow Manor");
		Meadow_as.setBounds(113, 163, 179, 23);
		profitsm.add(Meadow_as);
		
		JRadioButton Oasis_as = new JRadioButton("NSS The Oasis");
		Oasis_as.setBounds(113, 189, 179, 23);
		profitsm.add(Oasis_as);
		...
		chk_sm.addActionListener(new ActionListener() {
	    	...
	    	{
	    		String STR;
	    		 if(Oriental_as.isSelected()) {
	    			 HName = "NSS Mandarin Oriental";
				    }
				    
				    if(Indigo_as.isSelected()) {
				    	HName = "NSS Indigo";
				    }
				    
				    if(Apollo_as.isSelected()) {
				    	HName = "NSS New Apollo";
				    }
				    
				    if(Meadow_as.isSelected()) {
				    	HName = "NSS Meadow Manor";
				    }
				    
				    if(Oasis_as.isSelected()) {
				    	HName = "NSS The Oasis";
				    }
		...
		JLabel rest_sm_lbl = new JLabel("Select a restaurant");
		rest_sm_lbl.setFont(new Font("Times New Roman", Font.PLAIN, 16));
		rest_sm_lbl.setBounds(6, 56, 138, 20);
		maintenancesm.add(rest_sm_lbl);
		
		JRadioButton Oriental2_as2 = new JRadioButton("NSS Mandarin Oriental");
		Oriental2_as2.setBounds(113, 83, 179, 23);
		maintenancesm.add(Oriental2_as2);
		
		JRadioButton Indigo2_as2 = new JRadioButton("NSS Indigo");
		Indigo2_as2.setBounds(113, 111, 179, 23);
		maintenancesm.add(Indigo2_as2);
		
		JRadioButton Apollo2_as2 = new JRadioButton("NSS New Apollo");
		Apollo2_as2.setBounds(113, 137, 179, 23);
		maintenancesm.add(Apollo2_as2);
		
		JRadioButton Meadow2_as2 = new JRadioButton("NSS Meadow Manor");
		Meadow2_as2.setBounds(113, 163, 179, 23);
		maintenancesm.add(Meadow2_as2);
		
		JRadioButton Oasis2_as2 = new JRadioButton("NSS The Oasis");
		Oasis2_as2.setBounds(113, 189, 179, 23);
		maintenancesm.add(Oasis2_as2);
		...
		chk_sm2.addActionListener(new ActionListener() {
	    	...
	    	{
	    		String str;
	    		 if(Oriental2_as2.isSelected()) {
	    			 HName = "NSS Mandarin Oriental";
				    }
				    
				    if(Indigo2_as2.isSelected()) {
				    	HName = "NSS Indigo";
				    }
				    
				    if(Apollo2_as2.isSelected()) {
				    	HName = "NSS New Apollo";
				    }
				    
				    if(Meadow2_as2.isSelected()) {
				    	HName = "NSS Meadow Manor";
				    }
				    
				    if(Oasis2_as2.isSelected()) {
				    	HName = "NSS The Oasis";
				    }
